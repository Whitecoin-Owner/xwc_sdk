...
// xwc hc bind signature

func testXwcBindSign(t *testing.T) {
	var (
...
"XWCNRy59BQPvKdKGhh52oa7LiYkr69judc7oe"
...
2662347ms th_a       wallet.cpp:700                get_account          ] my account id 0.0.0 different from blockchain id 1.2.53
{
  ...
  "operations": [[
      10,{
        ...
        "crosschain_type": "ETH",
        "addr": "XWCNRy59BQPvKdKGhh52oa7LiYkr69judc7oe",
...
func testBtcSignAddr(t *testing.T) {
	var (
		...
		exp  = "H/wTWGMMH6F687Zjj2N48YAwMYmMR9ZN2EDk/kmqEd/lBszu8Xwcijg8lakUQy6EChkTTRPh6JksY7V/+VG7ykuc="
	)
...
func testLtcSignAddr(t *testing.T) {
	var ltcAddres = []struct {
	...
	},
		{
			...
			exp:  "H6zfPRpOp/on4gS/2JcpbHo9Up8cj4I+1zIYng64/RUzOqo0allqC7J+xwcStQY+E7+Ze9fZdac+KuMwBmXjvCww=",
		},
	}
